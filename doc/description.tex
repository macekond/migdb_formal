...
&	\Phi(s, Merge(l_1, l_2, l_n) = \inference{
		...
		equals(c_1, c_2)}{\begin{gathered}
			...
			reference(a) = l_n
		\end{gathered}} \\\\
&	\Psi(s, merge(l_1, l_2, l_n) = \inference{\exists t_1, t_2 \in tables(database(s)) : \\ name(t_1) = l_1 \wedge name(t_2) = l_2}{\begin{gathered}
...
\end{align*}
States of the evolution are shown in figures, although it could be described formally (for formal description see appendix \ref{sec:caseStudy}) the graphical illustrations are more illustrative.
