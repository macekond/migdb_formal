...
%TODO: prerequisities - lables (if they are unique it is not necessary to check the name)
%%%%%%%%%%%%%%%%%%%
...
$$
%TODO: are instances necessary on this level?
...
%TODO exist \rho to execute mapping and \rho' (?) just returning a name of mapped object
