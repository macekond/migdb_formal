...
&	\rho_{c}(c) = %\begin{cases}
		...
		\inference{|c| = 1}{table(name(c), primaryKey("Id", s_1), \varnothing, \varnothing)} % \end{cases} 
\\ 	
& c \in Class*
\end{align*}
...
%& col(street, APPSTRING, \varnothing, \varnothing), col(city, APPSTRING, \varnothing, \varnothing) \\
%& col(zip, APPSTRING, \varnothing, \varnothing), \varnothing), \\
%& tab("Address\_tmp1", pk("Id", s_1), col(street, APPSTRING, \varnothing, \varnothing),\\
%& \varnothing)) 
%\end{align*}
%\begin{align*}
%r &=\{ row("person", ["Id", 1], ["surname", "Griffin"], \\
...
%\end{align*}
%\begin{align*}
%t &=db(tab(Person, pk("Id", s_1), col(surname, DBSTRING, \varnothing, \varnothing), \\
