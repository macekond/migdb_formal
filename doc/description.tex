...
l \in Label, t : DbType, val \in Values,\\ cons : Constraint*, c : Column,d : Database
\end{align*}
...
\begin{align*}
	...
	\inference{|ps| = 1}{\begin{gathered}
		s \oplus addClass(cl(l_n, \varnothing, \varnothing)) \\ \oplus MoveProperty(l_s, l_n, ps, \mathbf{X}) \\ \oplus RemovePropertyData(l_s, ps)   
\end{gathered}}\\\\
