...
%\begin{align*}
%	v(l, fm, d) = \begin{cases}
%	\inference{fm = \varnothing}{d}\\ \\
%	\inference{|fm| > 1}{v(l, head(fm)) \bullet v(l, tail(fm))}\\ \\
%	\inference{|fm| = 1 \exists c \in pairs(first(fm)) : reference(c) = l \\ \wedge \exists e \in pairs(second(fm)) : reference(e) = l}{e \cup pairByRef(l,c)} 
% \end{cases}
%\end{align*}
